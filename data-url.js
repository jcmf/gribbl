...
(function() {
  var ext_to_type, is_urlsafe_with_squote, is_urlsafe_without_squote, prefixes_by_first_byte;
  ...
  module.exports = function(contents, opts) {
    ...
    if (!charset && (m = /;\s*charset\s*=\s*['"]?([^\s"';]+)/i.match(type))) {
    ...
    if (base64) {
      return "" + type + ";base64," + (contents.toString('base64'));
    }
  ...
  (function() {
    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      magic = _ref[_i];
      type = magic.type;
      _ref1 = (magic.exts || /\w+$/.match(magic.type)[0]).split(/\s+/);
      for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
        ext = _ref1[_j];
      ...
      _results.push((function() {
        ...
        for (_k = 0, _len2 = _ref2.length; _k < _len2; _k++) {
          ...
          if (prefix) {
            ...
            _results1.push((prefixes_by_first_byte[_name = prefix[0]] || (prefixes_by_first_byte[_name] = [])).append({
              prefix: prefix,
              type: type
            }));
          } else {
